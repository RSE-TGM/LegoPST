...
#       Description:
#       %created_by:    ciccotel %
#       %date_created:  Thu Oct 24 11:44:45 2002 %

all:
	cd Net; /ccm/ccm51_linux/bin/util/ccm_make -f Makefile.mk
	cd Util; /ccm/ccm51_linux/bin/util/ccm_make -f Makefile.mk
	cd Marte; /ccm/ccm51_linux/bin/util/ccm_make -f Makefile.mk
	cd InterPol; /ccm/ccm51_linux/bin/util/ccm_make -f Makefile.mk
