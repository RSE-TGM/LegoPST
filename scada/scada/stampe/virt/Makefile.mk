...
SORGENTI  = virtinv.c virtdisk.c virtini.c printalt.c virtrese.c\
	virttlbg.c virtsel.c

OGGETTI  = virtinv.o virtdisk.o virtini.o printalt.o virtrese.o\
	virttlbg.o virtsel.o
