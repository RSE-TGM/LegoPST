...
SORGENTI = tabper.c readtab.c racdbs.c tabul.c cprint.c lantab.c stfile.c\
      wildric.c  trasfile.c

OGGETTI = tabper.o readtab.o racdbs.o tabul.o cprint.o lantab.o stfile.o\
      wildric.o  trasfile.o
