# @stz_0 - elemento operatore: faceplate di comando (xstaz): bottone che apre una pagina di r02.dat.
# Clone di @val_0: e' un testo non topologico ('@' nel nome) il cui
# significato - la pagina - sta nel file .remap del modello, per nome istanza, e
...
# fissi (0=id, 2=cls, 3=ori, 5=lpath, 7=font). Il tag distintivo "hmistaz"
...
# Solo ASCII nel testo: con LANG=POSIX Tcl non decodifica UTF-8.
	...
	set mymodId [$c create text $x $y -text {[ xstaz: ? ]}]
...
#altrimenti topRead lo riporterebbe a nero
        global font.$mymodId
        set font.$mymodId [list helvetica 12 navy]
        $c itemconfigure $mymodId  -font "helvetica 12" -fill "navy"
	# tag distintivo dell'elemento: AGGIUNTO PER ULTIMO
	$c addtag hmistaz withtag $mymodId
