/**********************************************************************
*
*       C Source:               S_MAIN_WINDOW_PLOT.c
*       Subsystem:              1
*       Description:
*       %created_by:    famgr %
*       %date_created:  Tue Apr 16 17:10:54 1996 %
*
**********************************************************************/
#ifndef lint
static char *_csrc = "@(#) %filespec: S_MAIN_WINDOW_PLOT.c,2 %  (%full_filespec: 1,csrc,S_MAIN_WINDOW_PLOT.c,2 %)";
#endif
/*
   modulo S_MAIN_WINDOW_PLOT.c
   tipo 
   release 5.1
   data 11/13/95
   reserved @(#)S_MAIN_WINDOW_PLOT.c	5.1
*/
/*
        Variabile per identificazione della versione
*/
static char SccsID[] = "@(#)S_MAIN_WINDOW_PLOT.c	5.1\t11/13/95";
/*
...
static Widget	_Uxbuild_S_MAIN_WINDOW_PLOT(parent,PuntGraf)
Widget parent;
...
static Widget	_Ux_create_S_MAIN_WINDOW_PLOT(parent,PuntGraf)
Widget parent;
S_XLGRAFICO *PuntGraf;
{
	Widget                  rtrn;
	...
	rtrn = _Uxbuild_S_MAIN_WINDOW_PLOT(parent,PuntGraf);
...
Widget	create_S_MAIN_WINDOW_PLOT(parent,PuntGraf)
Widget parent;
S_XLGRAFICO *PuntGraf;
{
	Widget			_Uxrtrn;

	_Uxrtrn = _Ux_create_S_MAIN_WINDOW_PLOT(parent,PuntGraf);
