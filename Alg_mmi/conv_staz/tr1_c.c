...
*/
static char SccsID[] = "@(#)tr1_c.c	1.2\t6/16/93";
/*
   modulo tr1_c.c
   tipo 
   release 1.2
   data 6/16/93
   reserved @(#)tr1_c.c	1.2
*/
/*
	compilazione stazione di tipo tr1
*/
...
extern	FILE *fp_s01;
extern  FILE *fo;
extern	VARLEGO varlego [];
extern	STRIN_ST string[];
extern	COLLEG_ST colleg [];
extern	MODEL model[];
...
int staz_tr1_c(istaz,itipo,nmod)
int istaz;
int itipo;
int nmod;
{
...
*/
  ...
  if (string[1].stringa == NULL)
	...
	staz.s[istaz].umis[string[1].lun_stringa]=0;
	}
