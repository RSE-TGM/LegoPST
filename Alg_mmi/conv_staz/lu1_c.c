...
*/
static char SccsID[] = "@(#)lu1_c.c	1.2\t6/16/93";
/*
   modulo lu1_c.c
   tipo 
   release 1.2
   data 6/16/93
   reserved @(#)lu1_c.c	1.2
*/
/*
	compilazione stazione di tipo lu1
*/
...
int staz_lu1_c(istaz,itipo,nmod)
int istaz;
int itipo;
int nmod;
{
...
*/
  legge_riga( riga, &lun, &nriga);
  separa_str( riga, lun, nstr=2, string);
  if (strncmp(string[0].stringa,"LABELS",6) || (string[1].stringa == NULL ))
							 errore(ERR_LAB,riga);
