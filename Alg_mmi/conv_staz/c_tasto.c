...
*/
static char SccsID[] = "@(#)c_tasto.c	1.2\t6/16/93";
/*
   modulo c_tasto.c
   tipo 
   release 1.2
   data 6/16/93
   reserved @(#)c_tasto.c	1.2
*/
/*
...
int c_tasto(p_r02,sottotipo,pagina,num_w,cont_f,elenco,x,y)
TIPO_TASTO *p_r02;
...
*/
 ...
 if (!strcmp(string[3].stringa,stipo_perturb[i])) break;
  ...
  fprintf(fo,"\n output modello %d indice %d perturb %d",
	p_r02->out.nmod,p_r02->out.indice,p_r02->out.tipo_pert);
