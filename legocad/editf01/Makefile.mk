...
#       Description:
#       %created_by:    ciccotel %
#       %date_created:  Thu Nov  7 13:41:15 2002 %
...
#   release 2.6
#   data 96/03/19
#   reserved @(#)edit_f01.mk	2.6
#
.SUFFIXES: .i .o .c .h
EXECUTABLE	= $(LEGOCAD_BIN)/edit_f01
MAIN		= edit_f01.c
...
CFLAGS		= -I$(LEGOCAD_INCLUDE) -I$(LEGOROOT_INCLUDE) -D_AIX   -DXOPEN_CATALOG -DAIXV3 \
		  $(X_CFLAGS) $(MOTIF_CFLAGS) 

LEGO_LIBPATH    = -L$(LEGOCAD_LIB) -L$(LEGOROOT_LIB)

LIBPATH		= $(X_LIBPATH) $(MOTIF_LIBPATH) $(LEGO_LIBPATH)
LIBUTIL         = $(LEGOROOT_LIB)/libutilx.a $(LEGOCAD_LIB)/liblegocad.a
