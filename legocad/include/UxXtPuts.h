...
*       Description:
*       %created_by:    famgr %
*       %date_created:  Wed Apr 10 12:03:38 1996 %
*
**********************************************************************/
/*
...
/******************************************************************************/
/*				UxXtPuts.h				      */
/* Versione modificata per LEGOCAD ver.2.0                                    */
/******************************************************************************/
...
/*
 Prototiping delle funzioni aggiunte per LEGOCAD 2.0
*/

Widget lcCreateMenuPulldown(char *,Widget);
Widget lcCreateMenuOption(char *,Widget);
Widget lcCreateMainWindow(char *,Widget);
Widget lcCreateFrame(char *,Widget);
Widget lcCreateLabel(char *,Widget);
Widget lcDispatchEvent(XEvent *);
void   lcNextEvent(XEvent *);

Widget UxCreateWidget(Widget);
Widget UxCreateRowColumn(char *,Widget);
Widget UxCreateLabelGadget(char *,Widget);
Widget UxCreateToggleButtonGadget(char *,Widget);
Widget UxCreateToggleButton(char *,Widget);
Widget UxCreateText(char *,Widget);
Widget UxCreatePushButtonGadget(char *,Widget);
Widget UxCreatePushButton(char *,Widget);
Widget UxCreateMenuPulldown(char *,Widget);
Widget UxCreateMenuOption(char *,Widget);

/*
 Funzioni per la creazione di widgets e loro manipolazione
 Estensione per porting LEGOCAD
*/

#define UxNextEvent(event) \
        lcNextEvent(event)
...
#define UxDestroySwidget(wgt) lcDestroySwidget(wgt)
...
#define UxCreateRowColumn(name,parent) \
	XtCreateWidget(name,xmRowColumnWidgetClass,parent,NULL,0)

#define UxCreateLabelGadget(name,parent) \
	XtCreateWidget(name,xmLabelGadgetClass,parent,NULL,0)

#define UxCreateToggleButtonGadget(name,parent) \
	XtCreateWidget(name,xmToggleButtonGadgetClass,parent,NULL,0)

#define UxCreateToggleButton(name,parent) \
	XtCreateWidget(name,xmToggleButtonWidgetClass,parent,NULL,0)

#define UxCreateText(name,parent) \
	XtCreateWidget(name,xmTextWidgetClass,parent,NULL,0)

#define UxCreatePushButtonGadget(name,parent) \
        XtCreateWidget(name,xmPushButtonGadgetClass,parent,NULL,0)

#define UxCreatePushButton(name,parent) \
        XtCreateWidget(name,xmPushButtonWidgetClass,parent,NULL,0)

#define UxCreateMenuPulldown(name,parent) \
	lcCreateMenuPulldown(name,parent)

#define UxCreateMenuOption(name,parent) \
	lcCreateMenuOption(name,parent)

#define UxCreateMainWindow(name,parent) \
        lcCreateMainWindow(name,parent)

#define UxCreateFrame(name,parent) \
        lcCreateFrame(name,parent)

#define UxCreateLabel(name,parent) \
        lcCreateLabel(name,parent)

#define UxDispatchEvent(event) \
        lcDispatchEvent(event)
