...
# make_macros from makefile "Makefile.mk-6.1.1"
LEGOROOT_LIB=../AlgLib
LEGORT_LIB=../AlgLib
...
#       Description:
#       %created_by:    ciccotel %
#       %date_created:  Thu Nov  7 13:48:24 2002 %
...
EXECUTABLE	= $(LEGOCAD_BIN)/linfo
MAIN		= linfo.c
INTERFACES	= 	topLevelShell1.c 

APPL_OBJS	= UxXt.o reader.o readltm.o readdescr.o auxiliary.o
UX_DIR		= /usr/lpp/aic
X_LIBS		= $(X_LIB)
...
#
APPL_SRC	= UxXt.c reader.c readltm.c readdescr.c auxiliary.c
...
CFLAGS		= -D_BSD   -DXOPEN_CATALOG -DAIXV3 \
...
LIBS		= $(LIBUTIL)  $(X_LIBS) -lbsd $(STUB_LIBS) -lm
