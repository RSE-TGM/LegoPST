...
# make_macros from makefile "Makefile.mk-1.4"
LEGOROOT_LIB=../AlgLib
LEGORT_LIB=../AlgLib
...
APPL_OBJS	= UxXt.o aux.o read_f01.o
...
CFLAGS          =  $(C_FLAGS) \
                  $(X_CFLAGS) $(MOTIF_CFLAGS) $(LEGO_INCLUDE) -DTOPSIM \
                  -DSPMD -DRUNTIME -Dibmr2

LIBPATH		= $(X_LIBPATH) $(MOTIF_LIBPATH) $(LEGO_LIBPATH)
LIBUTIL         = $(LEGOCAD_LIB)/liblegocad.a $(LEGOCAD_LIB)/libicofile.a \
