...
# make_macros from makefile "mkMacro.mk-2"
LEGOROOT_LIB=../../AlgLib
LEGORT_LIB=../../AlgLib
...
#
#       Makefile Header:               mkMacro.mk
#       Subsystem:              1
#       Description:
#       %created_by:    lomgr %
#       %date_created:  Wed May 10 15:38:11 2000 %

#Makefile per comp. macro
...
OGGETTI = block_wdg.o draw.o files.o macro.o macro_wdg.o symb_wdg.o popup.o
all: $(LEGOCAD_BIN)/macro
$(LEGOCAD_BIN)/macro:$(OGGETTI) 
	@echo inizio compilazione macro
	cc -o $(LEGOCAD_BIN)/macro  $(OGGETTI)\
         -lm $(LIBUTIL) $(LIBSVIL)  -lX11
	@echo fine compilazione macro
