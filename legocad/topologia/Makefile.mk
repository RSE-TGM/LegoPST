...
#       Description:
#       %created_by:    ciccotel %
#       %date_created:  Thu Nov  7 15:09:46 2002 %
...
#########################################################################
.SUFFIXES: .i .o .c .h
EXECUTABLE	= $(LEGOCAD_BIN)/lg1
MAIN		= lg1.c
INTERFACES	= 	lg1MainWindow.c \
	varWin.c \
	selectModelBox.c \
	questionDB.c \
	messageDB.c \
...
APPL_OBJS	= UxXt.o _subproc.o\
                  init_modello.o read_moduli.o read_f01.o errore.o \
                  del_blocchi.o write_f01.o lg1_init_arg.o add_block.o\
                  graphics_interface.o gest_filtri.o verifica_file.o
...
CFLAGS		=  $(C_FLAGS) \
		  $(X_CFLAGS) $(MOTIF_CFLAGS)  $(LEGO_INCLUDE) \
		   -DTOPOLOGIA\
		  -DSPMD -DRUNTIME -Dibmr2 -I.
LIBPATH		= $(X_LIBPATH) $(MOTIF_LIBPATH) $(LEGO_LIBPATH)
LIBUTIL         = $(LEGOCAD_LIB)/liblegocad.a $(LEGOCAD_LIB)/macro_topol.a \
                  $(LEGOCAD_LIB)/libicofile.a \
                  $(LEGOROOT_LIB)/libutilx.a $(LEGOROOT_LIB)/libutil.a
LIBS		= $(LIBUTIL) \
                  $(X_LIBS) $(STUB_LIBS) -lbsd -lm 
