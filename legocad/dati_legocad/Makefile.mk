...
# make_macros from makefile "Makefile.mk-6.2.1"
LEGOROOT_LIB=../AlgLib
LEGORT_LIB=../AlgLib
...
#       Description:
#       %created_by:    ciccotel %
#       %date_created:  Thu Nov  7 13:35:09 2002 %
...
#########################################################################
.SUFFIXES: .i .o .c .h
EXECUTABLE	= $(LEGOCAD_BIN)/dati
MAIN		= dati.c
INTERFACES	=  dati_selDialog.c \
        dati_mainWin.c \
        vardata_dialog.c \
        NormParamDialog.c \
        messageBoxDialog1.c \
...
APPL_OBJS	= UxXt.o graf_list_interface.o
UX_DIR		= /usr/lpp/aic
UX_LIBPATH	= $(UX_DIR)/lib
X_LIBS		= $(X_LIB)

LEGO_LIBPATH    = -L$(LEGOCAD_LIB) -L$(LEGOROOT_LIB)
LEGO_CFLAGS     = -D$(OS) -I$(LEGOROOT_INCLUDE) -I$(LEGOCAD_INCLUDE) -I../autodoc
...
LIBUTIL         = $(LEGOCAD_LIB)/macro_dati.a $(LEGOCAD_LIB)/liblegocad.a \
                  $(LEGOCAD_LIB)/libicofile.a $(LEGOROOT_LIB)/libsim.a \
...
all: $(EXECUTABLE) $(INTERFACES) # remove_attr
