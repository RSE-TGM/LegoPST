C*********************************************************************
C       Fortran Source:             lego1.f
C       Subsystem:              1
C       Description:
C       %created_by:    lomgr %
C       %date_created:  Tue Aug 21 10:26:47 2001 %
C
C**********************************************************************
C
C Procedura contenete la variabile per l'identificazione della versione
C
      BLOCK DATA BDD_lego1_f
      CHARACTER*80  RepoID
      COMMON /CM_lego1_f / RepoID
      DATA RepoID/'@(#)1,fsrc,lego1.f,2'/
      END
C**********************************************************************
...
C
     ...
     $          IPV(M003),ICEI(M001),ICESU(N003), NPS(M003)
