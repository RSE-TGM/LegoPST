C*********************************************************************
C       Fortran Source:             stato1.f
C       Subsystem:              1
C       Description:
C       %created_by:    lomgr %
C       %date_created:  Tue Aug 21 10:30:04 2001 %
C
C**********************************************************************
...
C
      BLOCK DATA BDD_stato1_f
      CHARACTER*80  RepoID
      COMMON /CM_stato1_f / RepoID
      DATA RepoID/'@(#)1,fsrc,stato1.f,2'/
      END
C**********************************************************************
...
C
C Guag2024      DATA IBLK/' '/,IX/'X'/,ICAR/'I'/
