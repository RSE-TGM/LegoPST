C*********************************************************************
C       Fortran Source:             sswtch.f
C       Subsystem:              1
C       Description:
C       %created_by:    lomgr %
C       %date_created:  Tue Aug 21 10:29:58 2001 %
C
C**********************************************************************
...
C
      BLOCK DATA BDD_sswtch_f
      CHARACTER*80  RepoID
      COMMON /CM_sswtch_f / RepoID
      DATA RepoID/'@(#)1,fsrc,sswtch.f,2'/
      END
C**********************************************************************
