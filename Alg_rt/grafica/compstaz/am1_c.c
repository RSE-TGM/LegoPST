...
*/
static char SccsID[] = "@(#)am1_c.c	1.3\t3/23/95";
/*
   modulo am1_c.c
   tipo 
   release 1.3
   data 3/23/95
   reserved @(#)am1_c.c	1.3
*/
/*
...
int staz_am1_c(istaz,itipo,nmod)
int istaz;
int itipo;
int nmod;
{
...
/* legge la descrizione della stazione */
  ...
  if (strncmp(string[0].stringa,"DESCRIZIONE",11) || (string[1].stringa == NULL ))  errore(ERR_DES,riga);
  i=1;
  numbyte=0;
