#!/bin/sh
#
#  Script %name:	net_banco.sh %
#  Instance:		1
#  %version:		1 %
#  Description:		
#  %created_by:		lomgr %
#  %date_created:	Mon Nov  7 12:12:25 2005 %
...
#
banco SUPERUSER  -num_snap $SNAP_S -num_bktk $BACK_T -num_camp_cr $CAMPIO -num_var_cr $NUM_VA -num_pert_active $PERTUR -num_spare_forsnap $SPARE_ -clear_pert_bktk $PERTCL -time_bktk $TIME_BACK_T  &
#ksh `which alg_respawn` banco SUPERUSER  -num_snap $SNAP_S -num_bktk $BACK_T -num_camp_cr $CAMPIO -num_var_cr $NUM_VA -num_pert_active $PERTUR -num_spare_forsnap $SPARE_ -clear_pert_bktk $PERTCL -time_bktk $TIME_BACK_T  &
fi
fi
fi
